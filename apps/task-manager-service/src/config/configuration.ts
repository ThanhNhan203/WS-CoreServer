...
export default () => {
   ...
   const dbName = process.env.DB_NAME || 'WS-Task-Manager-Service';
   ...
   return {
      ...
      kafka: {
         ...
         clientId: process.env.KAFKA_CLIENT_ID || 'task-manager-service',
         groupId: process.env.KAFKA_GROUP_ID || 'task-manager-group',
      } as KafkaConfig,
